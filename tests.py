...
class TestPasswordValidator(unittest.TestCase):
    ...
    def test_valid_file(self):
        self.assertEqual(self.validator.get_count_valid_passwords_from_file(self.file_name), 1)

    def test_file_not_found(self):
        with self.assertRaises(BaseException):
            self.validator.get_count_valid_passwords_from_file('nonexistent.txt')
